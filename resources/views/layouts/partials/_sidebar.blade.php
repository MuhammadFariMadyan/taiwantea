            ...
            <ul>
                ...
                @can('admin-access')
                  <li>
                    ...
                    <li>
                        <a href="{{ route('order.list') }}" class="waves-effect"><i class="ti-pencil-alt"></i><span> Orders </span> <span class="menu-arrow"></span></a>
                    </li>
                  ...
                  <li><a href="{{ route('user.index') }}" class="waves-effect"><i class="ti-user"></i><span> Users </span></a></li>
                @endcan
                ...
                @can('supervisor-access')
                  <li>
                   ...
                   <li class="has_sub">
                        <a href="{{ route('order.list') }}" class="waves-effect"><i class="ti-pencil-alt"></i><span> Orders </span> <span class="label label-primary pull-right"></span> </a>
                    </li>
                    {{-- <li><a href="{{ route('hot_offer.index') }}" class="waves-effect"><i class="ti-gallery"></i><span> Hot Offers </span></a></li> --}}
                    {{-- <li class="has_sub">
                        <a href="javascript:void(0);" class="waves-effect"><i class="ti-gallery"></i><span> Gallery </span> <span class="menu-arrow"></span></a>
                ...
                @can('manager-access')
                  <li>
                    ...
                    <li>
                        <a href="{{ route('order.delivered') }}" class="waves-effect"><i class="ti-pencil-alt"></i><span> Orders </span> <span class="menu-arrow"></span></a>
                    </li>

                      <li class="text-muted menu-title">Manager</li>
                      <li><a href="{{ route('user.index') }}" class="waves-effect"><i class="ti-user"></i><span> Users </span></a></li>
                  </li>
                @endcan
                ...
                <li>
                    ...
                    onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();"><i class="ti-shift-left"></i><span> Logout </span></a></li>
