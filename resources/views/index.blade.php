...
<html lang="{{ config('app.locale') }}">
    <head>
        ...
        <title>{{ config('app.name', 'Taiwan Tea House') }}</title>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <div class="home-wrapper">
                            <h1 class="icon-main text-custom"><img src="{{ asset('assets/images/logo.png') }}" alt="velonic"></i></h1>
                            <h1 class="home-text"><span class="rotate">Taiwan Tea House,Taiwan Tea House,Taiwan Tea House</span></h1>
